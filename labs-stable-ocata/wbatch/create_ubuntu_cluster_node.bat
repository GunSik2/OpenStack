...
ECHO %time% Looking for %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
IF EXIST %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi goto got_base_disk
ECHO.
ECHO base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi not found in %IMGDIR%.
ECHO.
...
:got_base_disk
ECHO.
ECHO %time% Found %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
ECHO.
...
"%VBM%" modifyvm controller --nictype2 virtio --nic2 hostonly --hostonlyadapter2 "VirtualBox Host-Only Ethernet Adapter" --nicpromisc2 allow-all
IF %errorlevel% NEQ 0 GOTO :vbm_error
...
ECHO VBoxManage modifyvm controller --nictype3 virtio --nic3 hostonly --hostonlyadapter3 "VirtualBox Host-Only Ethernet Adapter #2" --nicpromisc3 allow-all
"%VBM%" modifyvm controller --nictype3 virtio --nic3 hostonly --hostonlyadapter3 "VirtualBox Host-Only Ethernet Adapter #2" --nicpromisc3 allow-all
IF %errorlevel% NEQ 0 GOTO :vbm_error
...
ECHO VBoxManage modifyhd --type multiattach %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
"%VBM%" modifyhd --type multiattach %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
IF %errorlevel% NEQ 0 GOTO :vbm_error

ECHO VBoxManage storageattach controller --storagectl SATA --port 0 --device 0 --type hdd --medium %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
"%VBM%" storageattach controller --storagectl SATA --port 0 --device 0 --type hdd --medium %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
IF %errorlevel% NEQ 0 GOTO :vbm_error
...
COPY %TOPDIR%\scripts\ubuntu\setup_neutron_controller.sh %AUTODIR%\11_setup_neutron_controller.sh
COPY %TOPDIR%\scripts\ubuntu\setup_self-service_controller.sh %AUTODIR%\12_setup_self-service_controller.sh
COPY %TOPDIR%\scripts\ubuntu\setup_neutron_controller_part_2.sh %AUTODIR%\13_setup_neutron_controller_part_2.sh
COPY %TOPDIR%\scripts\ubuntu\setup_horizon.sh %AUTODIR%\14_setup_horizon.sh
COPY %TOPDIR%\scripts\ubuntu\setup_cinder_controller.sh %AUTODIR%\15_setup_cinder_controller.sh
...
ECHO VBoxManage modifyvm compute1 --nictype2 virtio --nic2 hostonly --hostonlyadapter2 "VirtualBox Host-Only Ethernet Adapter" --nicpromisc2 allow-all
"%VBM%" modifyvm compute1 --nictype2 virtio --nic2 hostonly --hostonlyadapter2 "VirtualBox Host-Only Ethernet Adapter" --nicpromisc2 allow-all
IF %errorlevel% NEQ 0 GOTO :vbm_error
...
ECHO VBoxManage modifyvm compute1 --nictype3 virtio --nic3 hostonly --hostonlyadapter3 "VirtualBox Host-Only Ethernet Adapter #2" --nicpromisc3 allow-all
"%VBM%" modifyvm compute1 --nictype3 virtio --nic3 hostonly --hostonlyadapter3 "VirtualBox Host-Only Ethernet Adapter #2" --nicpromisc3 allow-all
IF %errorlevel% NEQ 0 GOTO :vbm_error
...
ECHO VBoxManage storageattach compute1 --storagectl SATA --port 0 --device 0 --type hdd --medium %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
"%VBM%" storageattach compute1 --storagectl SATA --port 0 --device 0 --type hdd --medium %IMGDIR%\base-vbadd-ocata-ubuntu-16.04-server-amd64.vdi
IF %errorlevel% NEQ 0 GOTO :vbm_error

ECHO VBoxManage createhd --format VDI --filename %IMGDIR%\compute1-sdb.vdi --size 1040
"%VBM%" createhd --format VDI --filename %IMGDIR%\compute1-sdb.vdi --size 1040
IF %errorlevel% NEQ 0 GOTO :vbm_error
...
TIMEOUT /T 1 /NOBREAK
ECHO VBoxManage snapshot controller take controller_-_compute1_node_installed
"%VBM%" snapshot controller take controller_-_compute1_node_installed
IF %errorlevel% NEQ 0 GOTO :vbm_error
